...
class MyCom extends Frame implements MouseListener{
	...
	MyCom(){	
		...
		//임의적으로 창 늘리고, 줄이기 불가능. 화면가운데로 창이뜨게
		setResizable(false);
